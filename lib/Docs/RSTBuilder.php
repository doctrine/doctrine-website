...
SIDEBAR;
    ...
    private function copyRst(Project $project, ProjectVersion $version) : void
    {
        ...
        $sidebar     = file_exists($sidebarPath) ? (string) file_get_contents($sidebarPath) : self::DEFAULT_SIDEBAR;
    ...
    {
        return (string) realpath($project->getAbsoluteDocsPath($this->projectsPath));
    }
